...
std::function — это шаблонный класс из стандартной библиотеки C++, который предназначен для хранения и вызова любых вызываемых объектов: функций, лямбд, функторов, а также методов классов. Он предоставляет унифицированный интерфейс для работы с ними.

Основные отличия от указателей на функции:
  Гибкость
  Безопасность
  Удобство
